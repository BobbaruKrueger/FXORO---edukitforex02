(function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
        ...
        var phoneemptyerrors = {
            ...
            "hu": "TelefonszÃ¡m megadÃ¡sa kÃ¶telezÅ‘",
            "tr": "Telefon boÅŸ bÄ±rakÄ±lamaz"
        };
        var phonedigiterrors = {
            "en": "Phone number must be 6 digits or longer",
            "it": "Il numero di telefono deve essere di 6 cifre o piÃ¹",
            "ro": "Numarul de telefon trebuie sa aiba 6 cifre sau mai multe",
            "hu": "A telefonszÃ¡mnak minimum 6 szÃ¡mjegyÅ±nek szÃ¼ksÃ©ges lennie vagy tÃ¶bbnek",
            "tr": "Telefon numarasÄ± 6 veya daha fazla numaradan oluÅŸmalÄ±dÄ±r"
        };
        var userexisterrors = {
            "en": "User already exists",
            "it": "L'utente esiste giÃ ",
            "ro": "Utilizatorul existÄƒ deja",
            "hu": "FelhasznÃ¡lÃ³ mÃ¡r lÃ©tezik",
            "tr": "KullanÄ±cÄ± adÄ± zaten mevcut"
        };
        var emailinvaliderrors = {
            "en": "Invalid Email",
            "it": "Indirizzo email non valido",
            "ro": "Email invalid",
            "hu": "Ã‰rvÃ©nytelen Email cÃ­m",
            "tr": "GeÃ§ersiz e-posta"
        };
        var phoneinvaliderrors = {
            "en": "Invalid Phone number",
            "it": "Il numero di telefono non è valido",
            "ro": "NumÄƒr de telefon invalid",
            "hu": "Ã‰rvÃ©nytelen telefonszÃ¡m",
            "tr": "GeÃ§ersiz telefon"
        };
        var countryerrors = {
            "en": "You must choose country ",
            "it": "Selezionare il Paese",
            "ro": "Trebuie sa alegi o tara",
            "hu": "KÃ©rjÃ¼k, vÃ¡lassza ki az orszÃ¡got ",
            "tr": "LÃ¼tfen Ã¼lkenizi seÃ§in "
        };
        var agreeerrors = {
            ...
            "hu": "A kÃ¶vetkezÅ‘ lÃ©pÃ©shez, kÃ©rjÃ¼k egyezzen bele, hogy kommunikÃ¡ciÃ³ban rÃ©szesÃ¼l az FXORO szolgÃ¡ltatÃ³tÃ³l",
            "tr": "Devam etmek iÃ§in FXORO'dan bildirim almayÄ± kabul edin"
        };
        var leadexisterrors = {
            "en": "Lead Already Exists",
            "it": "Il Lead giÃ  esiste",
            "ro": "Lead-ul existÄƒ deja",
            "hu": "FelhasznÃ¡lÃ³ mÃ¡r lÃ©tezik",
            "tr": "KullanÄ±cÄ± adÄ± zaten mevcut"
        };
        ...
        function fbshareCurrentPage() {
            window.open("https://www.facebook.com/sharer/sharer.php?u=" + escape(window.location.href) + "&t=fxoro", '',
            ...
            if (undefined == error.responseJSON) {
                ...
                switch (error.responseJSON.Message) {
                    ...
                    case '1002':
                        ...
                        errorText = userexisterrors[language];
                    ...
                    case '1003':
                        ...
                        break;
                    case '1004':
                        errorText = leadexisterrors[language];
        ...
        $(document).ready(function () {
            ...
            /*Put risk warning under each button of start now/send now/ etc */
            isdubai = 0;
            ...
            $(".submitformmain").submit(function (event) {
                    ...
                    if ($(this).val() == '') {
                        if (($(this).attr('type') != 'hidden') && ($(this).attr('id') != 'loginpass') && ($(this).attr('id') != 'loginuser')) {
                            if ($(this).hasClass('fnameclass')) {
                                $(this).next().html(fnameerrors[language]);
                                $(this).parent().addClass('inputwitherror');
                                haserrorline1 = 1;
                            } else if ($(this).hasClass('lnameclass')) {
                                $(this).next().html(lnameerrors[language]);
                                $(this).parent().addClass('inputwitherror');
                                haserrorline1 = 1;
                            } else if ($(this).hasClass('useremailclass')) {
                                $(this).next().html(emailemptyerrors[language]);
                                $(this).parent().addClass('inputwitherror');
                                emailempty = 1;
                                haserrorline1 = 1;
                            } else if ($(this).hasClass('phonenumberclass')) {
                                $(this).parent().parent().parent().find(".phoneerrorclass").html(phoneemptyerrors[language]);
                ...
                if (!phoneempty) {
                    ...
                    if (!pattern.test(phoneformat)) {
                        ...
                        $(this).parent().parent().parent().find(".phoneerrorclass").html(phoneinvaliderrors[language]);
                        ...
                        if (phoneformat.length < 6) {
                            ...
                            $(this).parent().parent().parent().find(".phoneerrorclass").html(phonedigiterrors[language]);
                            $(this).parent().parent().parent().find('.input.phone').addClass('inputwitherror');
                            tosubmit = 0;
                            haserrorline2 = 1;
                        } else {
                            ...
                            phonelib.isValid(phoneNumber, function (err, result) {
                                ...
                                if (result.isValid == false) {
                                    ...
                                    $('#phonenumber').parent().next().html(phoneinvaliderrors[language]);
                ...
                if (!emailempty) {
                    ...
                    if (!pattern.test(email) && email.length > 0) {
                        $(this).parent().parent().parent().find('.emailerrorclass').html(emailinvaliderrors[language]);
                ...
                if (!($('#agreeinput').is(':checked'))) {
                    tosubmit = 0;
                    $("#notagreeerror").html(agreeerrors[language]);
                } else {
                    $("#notagreeerror").html('');
                }
