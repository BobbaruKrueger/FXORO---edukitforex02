...
var fnameerrors = {"en": "First name must not be empty", "it": "Il nome non deve essere vuoto", "ro": "Prenumele trebuie completat", "hu": "Keresztnév kitöltése kötelező", "tr": "İsim boş bırakılamaz"};
var lnameerrors = {"en": "Last name must not be empty", "it": "Il cognome non deve essere vuoto", "ro": "Numele trebuie completat", "hu": "Vezetéknév kitöltése kötelező", "tr": "Soyadı boş bırakılamaz"};
var emailemptyerrors = {"en": "Email must not be empty", "it": "L'email non deve essere vuota", "ro": "Emailul trebuie completat", "hu": "Email cím megadása kötelező", "tr": "E-posta boş bırakılamaz"}; 
var phoneemptyerrors = {"en": "Phone number must not be empty", "it": "Inserire il numero di telefono", "ro": "Numarul de telefon trebuie completat","hu": "Telefonszám megadása kötelező", "tr": "Telefon boş bırakılamaz"};
var phonedigiterrors = {"en": "Phone number must be 6 digits or longer", "it": "Il numero di telefono deve essere di 6 cifre o più", "ro": "Numarul de telefon trebuie sa aiba 6 cifre sau mai multe", "hu": "A telefonszámnak minimum 6 számjegyűnek szükséges lennie vagy többnek","tr": "Telefon numarası 6 veya daha fazla numaradan oluşmalıdır"}; 
var userexisterrors =  {"en": "User already exists", "it": "L'utente esiste già","ro": "Utilizatorul există deja","hu": "Felhasználó már létezik","tr": "Kullanıcı adı zaten mevcut"};   
var emailinvaliderrors = {"en": "Invalid Email", "it": "Indirizzo email non valido", "ro": "Email invalid","hu": "Érvénytelen Email cím", "tr": "Geçersiz e-posta"}; 
var phoneinvaliderrors = {"en": "Invalid Phone number", "it": "Il numero di telefono non è valido","ro": "Număr de telefon invalid","hu": "Érvénytelen telefonszám","tr": "Geçersiz telefon"};   
var countryerrors = {"en": "You must choose country ", "it": "Selezionare il Paese","ro": "Trebuie sa alegi o tara","hu": "Kérjük, válassza ki az országot ","tr": "Lütfen ülkenizi seçin "};
var agreeerrors = {"en": "To proceed, You must agree to receive communications from ORACLE SIGNALS", "it": "Per procedere e' necessario approvare la ricezione dei segnali da Oracle Signals", "ro": "Pentru a continua, trebuie sa fii de acord sa primesti mesaje din partea ORACLE SIGNALS","hu": "A következő lépéshez, kérjük egyezzen bele, hogy kommunikációban részesül az ORACLE SIGNALS szolgáltatótól","tr": "Devam etmek için ORACLE SIGNALS'dan bildirim almayı kabul edin"};
var leadexisterrors =  {"en": "Lead Already Exists", "it": "Il Lead già esiste","ro": "Lead-ul există deja","hu": "Felhasználó már létezik","tr": "Kullanıcı adı zaten mevcut"};                       
